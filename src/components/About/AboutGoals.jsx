    ...
    >
      ...
      <div className="flex flex-col items-center mb-12">
        <motion.h2
          ...
          className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-purple-500 to-pink-400 bg-clip-text text-transparent mb-3 sm:mb-4 text-center"
        >
          {t("about.goals.title")}
        </motion.h2>
        <motion.div
          variants={borderVariants}
          className="w-20 h-1 sm:h-1.25 bg-gradient-to-r from-purple-400 to-pink-300 rounded-full origin-center mx-auto"
        />
      </div>
        ...
        >
          {goalsParagraphs.map((para, idx) => (
            <div key={idx} className="relative mb-3 last:mb-0">
              ...
              <p className="text-base sm:text-lg font-light text-gray-800 leading-snug">
                {parseGoals(para, "normal")}
              </p>
              {/* Couche gradient : mots clés en gradient, reste masqué */}
              <p
                className="absolute inset-0 pointer-events-none text-base sm:text-lg font-light leading-snug bg-gradient-to-r from-purple-400 to-pink-300 bg-clip-text"
                style={{
