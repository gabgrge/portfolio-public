 ...
 */
function App() {
  // Utilise i18n pour la gestion de la langue
  const { i18n } = useTranslation();

  // Détermine la langue actuelle à partir de i18n
  const currentLang =
    i18n.language && i18n.language.toLowerCase().startsWith("fr") ? "fr" : "en";
  ...
  // Effet pour mettre à jour la langue du document HTML
  useEffect(() => {
    document.documentElement.lang = currentLang;
  }, [currentLang, i18n.language]);

  // Effet de gestion du thème (clair/sombre)
  useEffect(() => {
      ...
      >
        <main>
          ...
          <section id="hero" className="snap-start min-h-screen">
            <Hero withHeader={true} toggleLang={toggleLang} />
          </section>
        ...
        <FloatingWidgets projectsRef={projectsRef} toggleLang={toggleLang} />
      </div>
